...
const PatientQuestionnaire = ({ initialPatientId, existingData }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    tobacco_chewing_status: existingData?.tobacco_chewing_frequency || '',
    tobacco_chewing_times_per_day: !isNaN(existingData?.tobacco_chewing_frequency) ? existingData?.tobacco_chewing_frequency : '',
    tobacco_chewing_duration_years: existingData?.tobacco_chewing_duration || '',
    betel_nut_chewing_status: existingData?.betel_nut_chewing_frequency || '',
    betel_nut_chewing_times_per_day: !isNaN(existingData?.betel_nut_chewing_frequency) ? existingData?.betel_nut_chewing_frequency : '',
    betel_nut_chewing_duration_years: existingData?.betel_nut_chewing_duration || '',
    gutkha_chewing_status: existingData?.gutkha_chewing_frequency || '',
    gutkha_chewing_times_per_day: !isNaN(existingData?.gutkha_chewing_frequency) ? existingData?.gutkha_chewing_frequency : '',
    gutkha_chewing_duration_years: existingData?.gutkha_chewing_duration || '',
    betel_quid_chewing_status: existingData?.betel_quid_chewing_frequency || '',
    betel_quid_chewing_times_per_day: !isNaN(existingData?.betel_quid_chewing_frequency) ? existingData?.betel_quid_chewing_frequency : '',
    betel_quid_chewing_duration_years: existingData?.betel_quid_chewing_duration || '',
    mishri_use_status: existingData?.mishri_use_frequency || '',
    mishri_use_times_per_day: !isNaN(existingData?.mishri_use_frequency) ? existingData?.mishri_use_frequency : '',
      ...
      if (response.ok) {
        ...
        if (latestData) {
          ...
          setFormData({
            ...
            tobacco_chewing_status: latestData?.tobacco_chewing_frequency || '',
            tobacco_chewing_times_per_day: !isNaN(latestData?.tobacco_chewing_frequency) ? latestData?.tobacco_chewing_frequency : '',
            tobacco_chewing_duration_years: latestData?.tobacco_chewing_duration || '',
            betel_nut_chewing_status: latestData?.betel_nut_chewing_frequency || '',
            betel_nut_chewing_times_per_day: !isNaN(latestData?.betel_nut_chewing_frequency) ? latestData?.betel_nut_chewing_frequency : '',
            betel_nut_chewing_duration_years: latestData?.betel_nut_chewing_duration || '',
            gutkha_chewing_status: latestData?.gutkha_chewing_frequency || '',
            gutkha_chewing_times_per_day: !isNaN(latestData?.gutkha_chewing_frequency) ? latestData?.gutkha_chewing_frequency : '',
            gutkha_chewing_duration_years: latestData?.gutkha_chewing_duration || '',
            betel_quid_chewing_status: latestData?.betel_quid_chewing_frequency || '',
            betel_quid_chewing_times_per_day: !isNaN(latestData?.betel_quid_chewing_frequency) ? latestData?.betel_quid_chewing_frequency : '',
            betel_quid_chewing_duration_years: latestData?.betel_quid_chewing_duration || '',
            mishri_use_status: latestData?.mishri_use_frequency || '',
            mishri_use_times_per_day: !isNaN(latestData?.mishri_use_frequency) ? latestData?.mishri_use_frequency : '',
